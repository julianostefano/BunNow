 ...
 */
export const ServiceNowDateTimeSchema = z
  .string()
 ...
 */
export const ServiceNowBooleanSchema = z
  .string()
  .refine(
 ...
 */
export const ServiceNowResponseSchema = <T extends z.ZodTypeAny>(
  resultSchema: T,
) =>
  z.object({
