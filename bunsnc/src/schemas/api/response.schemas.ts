...
export const PaginatedResponseTypeBox = (itemSchema: any) => t.Object({
 ...
 */
export const ServiceNowRecordSchema = z.object({
  sys_id: SysIdSchema,
...
export const UpdateRecordResponseTypeBox = t.Object({
  data: t.Object({
    ...
    table: t.String(),
    changes: t.Optional(t.Record(t.String(), t.Object({
      old_value: t.Any(),
      new_value: t.Any()
    })))
  }),
 ...
 */
export const ListRecordsResponseSchema = PaginatedResponseSchema(ServiceNowRecordSchema);

export const ListRecordsResponseTypeBox = PaginatedResponseTypeBox(ServiceNowRecordTypeBox);
...
export const AttachmentMetadataTypeBox = t.Object({
  ...
  state: t.Union([t.Literal('pending'), t.Literal('available'), t.Literal('processing'), t.Literal('error')]),
  hash: t.Optional(t.String()),
  table_name: t.String(),
  table_sys_id: t.String({ minLength: 32, maxLength: 32, pattern: '^[0-9a-f]{32}$' }),
  sys_created_on: t.String(),
  sys_created_by: t.String()
});
...
export const HealthResponseTypeBox = t.Object({
  ...
  checks: t.Object({
    database: t.Union([t.Literal('ok'), t.Literal('error'), t.Literal('warning')]),
    servicenow: t.Union([t.Literal('ok'), t.Literal('error'), t.Literal('warning')]),
    redis: t.Optional(t.Union([t.Literal('ok'), t.Literal('error'), t.Literal('warning')])),
    opensearch: t.Optional(t.Union([t.Literal('ok'), t.Literal('error'), t.Literal('warning')]))
  })
});
