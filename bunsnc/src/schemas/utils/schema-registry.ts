...
export class UnifiedSchemaRegistry {
  ...
  private initializeDefaultSchemas(): void {
    ...
    this.registerSchema('service-task-completion', ServiceTaskCompletionSchema, {
      category: SchemaCategory.TICKETS,
      table: 'sc_task',
      version: '1.0.0',
    ...
    this.registerSchema('service-task-assignment', ServiceTaskAssignmentSchema, {
      category: SchemaCategory.TICKETS,
      table: 'sc_task',
      version: '1.0.0',
...
export const CommonSchemas = {
  ...
  ChangeTaskCreation: () => unifiedRegistry.getZodSchema('change-task-creation'),
  ChangeTaskCompletion: () => unifiedRegistry.getZodSchema('change-task-completion'),
  
  ServiceTask: () => unifiedRegistry.getZodSchema('service-task'),
  ServiceTaskCreation: () => unifiedRegistry.getZodSchema('service-task-creation'),
  ServiceTaskCompletion: () => unifiedRegistry.getZodSchema('service-task-completion'),
...
export const ElysiaSchemas = {
  ...
  ChangeTaskCreation: () => unifiedRegistry.getTypeBoxSchema('change-task-creation'),
  
  ServiceTask: () => unifiedRegistry.getTypeBoxSchema('service-task'),
  ServiceTaskCreation: () => unifiedRegistry.getTypeBoxSchema('service-task-creation'),
