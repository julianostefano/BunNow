...
export const ServiceCatalogTaskSchema = BaseTicketSchema.extend({
  ...
  automation_status: z
    .enum(["not_applicable", "pending", "running", "completed", "failed"])
    .optional(),
 ...
 */
export const ServiceTaskStateTransitionsSchema = z
  .object({
 ...
 */
export const ServiceTaskCompletionSchema = z
  .object({
    sys_id: SysIdSchema,
 ...
 */
export const ServiceTaskAssignmentSchema = z
  .object({
    sys_id: SysIdSchema,
  ...
  .refine(
    (data) => {
      ...
      return (
        data.assignment_group || data.assigned_to || data.fulfillment_group
      );
    },
    {
      message:
        "Either assignment_group, assigned_to, or fulfillment_group must be specified",
      path: ["assignment"],
    },
  );
...
export const ServiceTaskQuerySchema = z.object({
  ...
  state: z
    .union([ServiceTaskStateSchema, z.array(ServiceTaskStateSchema)])
    .optional(),
 ...
 */
export const ServiceDeliverySLASchema = z
  .object({
    task_id: SysIdSchema,
...
export type ServiceTaskStateTransition = z.infer<
  typeof ServiceTaskStateTransitionsSchema
>;
