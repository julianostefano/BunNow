 ...
 */
export const ChangeTaskStateTransitionsSchema = z.object({
  from_state: ChangeTaskStateSchema,
  to_state: ChangeTaskStateSchema,
  action: z.enum(['open', 'assign', 'start_work', 'complete', 'skip', 'incomplete', 'reopen']),
 ...
 */
export const ChangeTaskAssignmentSchema = z.object({
  sys_id: SysIdSchema,
...
export const ChangeTaskQuerySchema = z.object({
  ...
  state: z.union([ChangeTaskStateSchema, z.array(ChangeTaskStateSchema)]).optional(),
 ...
 */
export const ChangeTaskDependencySchema = z.object({
  task_id: SysIdSchema,
...
export type ChangeTaskStateTransition = z.infer<typeof ChangeTaskStateTransitionsSchema>;
