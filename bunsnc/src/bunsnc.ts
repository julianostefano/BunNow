...
export type { BatchRequest, BatchResult, IBatchAPI } from "./api/BatchAPI";

export type { ITableAPI } from "./api/TableAPI";

export type { IAttachmentAPI } from "./api/AttachmentAPI";

export type { IServiceNowClient } from "./client/ServiceNowClient";
