...
export class ModernWebServer {
  ...
  private initializeServer(): void {
      ...
      .use(swagger({
        documentation: {
          info: {
            ...
            version: '2.0.0',
            description: 'Modern ServiceNow interface with real-time analytics and file-based routing',
          },
          tags: [
            ...
            { name: 'Real-time', description: 'Real-time monitoring and SSE' },
    ...
    try {
      console.log("📁 Loading file-based routes from:", this.config.routes?.directory);

      this.app.use(autoroutes({
...
export function createModernWebServer(config: Partial<ModernServerConfig> = {}): ModernWebServer {
