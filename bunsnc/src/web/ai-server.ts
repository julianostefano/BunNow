      ...
      .use(swagger({
        documentation: {
          info: {
            ...
            version: '1.0.0',
            description: 'AI-powered ServiceNow integration with neural search, document intelligence, and ticket analysis capabilities',
          },
          tags: [
          ...
          servers: [
            { url: `http://localhost:${this.port}`, description: 'AI Services Server' }
          ]
        },
        path: '/docs'
      }))
  ...
  private async initializeServices(): Promise<void> {
    try {
      ...
      const services = [
        ...
        { name: 'OpenSearch', client: new OpenSearchClient({
...
if (import.meta.main) {
  ...
  process.on('unhandledRejection', (reason, promise) => {
    logger.error('[AI-Server] Unhandled promise rejection at:', promise, 'reason:', reason);
    process.exit(1);
  });
