  ...
  },
  {
    ...
    children: [
      ...
      { label: "AI Assistant", icon: "bot", href: "/ui/ai/assistant" },
      {
        ...
        icon: "trending-up",
        href: "/ui/intelligence",
      },
      {
        label: "Predictive Analytics",
        icon: "line-chart",
        href: "/ui/analytics/predictive",
      },
      {
      ...
      },
      {
        ...
        icon: "file-text",
        href: "/ui/ai/documents",
      },
      {
        label: "Neural Search",
        icon: "scan-search",
        href: "/ui/search/neural",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      { label: "SLA Metrics", icon: "timer", href: "/ui/sla" },
      {
        ...
        icon: "file-badge",
        href: "/ui/sla/contractual",
      },
      {
        label: "Violation Tracking",
        icon: "alert-triangle",
        href: "/ui/sla/violations",
      },
      {
        label: "Enhanced Metrics",
        icon: "bar-chart-4",
        href: "/ui/metrics/enhanced",
      },
      {
  ...
  },
  {
    ...
    children: [
      { label: "Preferences", icon: "sliders", href: "/ui/settings" },
      {
        label: "Notifications",
        icon: "bell",
        href: "/ui/settings/notifications",
      },
