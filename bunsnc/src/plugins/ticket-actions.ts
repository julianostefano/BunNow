...
export const ticketActionsPlugin = new Elysia({
  ...
  .onStart(() => {
    console.log('🎫 Ticket Actions Plugin starting - workflow operations available');
  })

  // Business logic methods - replace direct service calls
  .decorate('resolveTicket', async function(
    this: {},
  ...
  .decorate('closeTicket', async function(
    this: {},
  ...
  .decorate('reopenTicket', async function(
    this: {},
  ...
  .decorate('assignTicket', async function(
    this: {},
  ...
  .decorate('updatePriority', async function(
    this: {},
  ...
  .decorate('updateCategory', async function(
    this: {},
  ...
  .decorate('escalateTicket', async function(
    this: {},
   ...
   */
  .post('/resolve', async ({ resolveTicket, body }) => {
   ...
   */
  .post('/close', async ({ closeTicket, body }) => {
   ...
   */
  .post('/reopen', async ({ reopenTicket, body }) => {
   ...
   */
  .post('/assign', async ({ assignTicket, body }) => {
   ...
   */
  .post('/priority', async ({ updatePriority, body }) => {
   ...
   */
  .post('/category', async ({ updateCategory, body }) => {
   ...
   */
  .post('/self-assign', async ({ selfAssignTicket, body }) => {
   ...
   */
  .post('/escalate', async ({ escalateTicket, body }) => {
...
export const createTicketActionsPlugin = (config?: {
  ...
  return (app: Elysia) => app
    ...
    .onStart(() => {
      console.log('🔌 Ticket Actions Plugin applied - workflow operations available via dependency injection');
      console.log('📦 Direct ticket action imports eliminated - using plugin injection');
    });
};
