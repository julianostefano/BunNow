...
export const serviceNowPlugin = new Elysia({
  ...
  seed: {
    ...
    createServiceNowRecord:
      {} as ServiceNowPluginContext["createServiceNowRecord"],
    updateServiceNowRecord:
      {} as ServiceNowPluginContext["updateServiceNowRecord"],
    deleteServiceNowRecord:
      {} as ServiceNowPluginContext["deleteServiceNowRecord"],
  ...
  .decorate(
    ...
    async function (
      ...
      try {
        ...
        const taskSLAResponse = await this.serviceNowBridge.queryTable(
          "task_sla",
          {
  ...
  .decorate(
    ...
    async function (
      ...
      try {
        ...
        const response = await this.serviceNowBridge.queryTable(
          "contract_sla",
          {
            sysparm_query: query,
            sysparm_display_value: "all",
...
export const createServiceNowPlugin = (config?: {
  ...
  return (app: Elysia) =>
    app.use(serviceNowPlugin).onStart(() => {
      console.log(
        "🔌 ServiceNow Plugin applied - bridge service available via dependency injection",
      );
      console.log(
        "📦 Self-referencing HTTP calls eliminated - using direct service injection",
      );
    });
};
