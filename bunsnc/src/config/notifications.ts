  ...
  return {
    queue: {
      ...
      queue: {
        ...
        cleanupInterval: parseInt(process.env.NOTIFICATION_CLEANUP_INTERVAL || '300000'),
        processingInterval: parseInt(process.env.NOTIFICATION_PROCESSING_INTERVAL || '1000')
      },
      rateLimits: {
        perMinute: parseInt(process.env.NOTIFICATION_RATE_LIMIT_MINUTE || '100'),
