  ...
  .post(
    ...
    async ({ body }) => {
      try {
        ...
        const samlConfig: SAMLConfig = {
          ...
          baseUrl: body.baseUrl || process.env.SERVICENOW_INSTANCE_URL || 'https://iberdrola.service-now.com',
    ...
    },
    {
      body: t.Object({
        ...
        instance: t.Optional(t.String({ description: 'ServiceNow instance name' })),
  ...
  .post(
    ...
    async ({ body }) => {
      try {
        ...
        const validationResult = await serviceNowSAMLAuth.validateAuth(samlConfig, mockAuthData);
      ...
      try {
        ...
        return {
          ...
          environment: {
            ...
            hasCredentials: !!(process.env.SERVICENOW_USERNAME && process.env.SERVICENOW_PASSWORD)
          },
          timestamp: new Date().toISOString()
        };
    ...
    async () => {
      try {
        ...
        const samlConfig: SAMLConfig = {
          ...
          baseUrl: process.env.SERVICENOW_INSTANCE_URL || 'https://iberdrola.service-now.com',
          instance: 'iberdrola',
        ...
        if (!samlConfig.username || !samlConfig.password) {
          return {
            ...
            message: 'Set SERVICENOW_USERNAME and SERVICENOW_PASSWORD environment variables',
            timestamp: new Date().toISOString()
          };
        }
