...
describe('ServiceNow Exceptions', () => {
  ...
  describe('Error Handler', () => {
    test('should rethrow ServiceNowException as-is', () => {
      ...
      expect(() => handleServiceNowError(originalException)).toThrow(AuthenticationException);
      expect(() => handleServiceNowError(originalException)).toThrow('Auth failed');
    });
    ...
    test('should handle HTTP errors', () => {
      ...
      expect(() => handleServiceNowError(httpError)).toThrow('Resource not found');
    });
    ...
    test('should handle network errors', () => {
      ...
      expect(() => handleServiceNowError(networkError)).toThrow(InstanceException);
      expect(() => handleServiceNowError(networkError)).toThrow('Cannot connect to ServiceNow instance');
    });
    ...
    test('should handle connection refused errors', () => {
      ...
      expect(() => handleServiceNowError(connectionError)).toThrow(InstanceException);
    });
    ...
    test('should handle timeout errors', () => {
      ...
      expect(() => handleServiceNowError(timeoutError)).toThrow(RequestException);
      expect(() => handleServiceNowError(timeoutError)).toThrow('Request timeout');
    });
    ...
    test('should handle generic errors', () => {
      ...
      expect(() => handleServiceNowError(genericError)).toThrow(ServiceNowException);
      expect(() => handleServiceNowError(genericError)).toThrow('Something went wrong');
    });

    test('should include operation context', () => {
      const error = { message: 'Failed' };
      
      expect(() => handleServiceNowError(error, 'create record')).toThrow('Failed');
    });
  ...
  describe('Error Decorator', () => {
    ...
    test('should handle async method errors', async () => {
      ...
      await expect(instance.failingMethod()).rejects.toThrow(ServiceNowException);
    });
  ...
  describe('Edge Cases', () => {
    test('should handle null/undefined errors', () => {
      ...
      expect(() => handleServiceNowError(undefined)).toThrow(ServiceNowException);
    });
    ...
    test('should handle string errors', () => {
      expect(() => handleServiceNowError('String error')).toThrow('String error');
    });
    ...
    test('should handle errors with both status and statusCode', () => {
      ...
      expect(() => handleServiceNowError(error)).toThrow(AuthenticationException);
    });
  });
});