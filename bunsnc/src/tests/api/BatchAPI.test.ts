...
class MockServiceNowClient {
  ...
  constructor() {
    this.records.set('incident', [
      { sys_id: '1', state: '1', priority: '3', short_description: 'Test incident 1' },
      { sys_id: '2', state: '2', priority: '2', short_description: 'Test incident 2' },
      { sys_id: '3', state: '3', priority: '1', short_description: 'Test incident 3' }
    ]);
  }
