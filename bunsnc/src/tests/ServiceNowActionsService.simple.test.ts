...
describe("ServiceNow Actions Service Simple Tests", () => {
  ...
  beforeEach(() => {
    actionsService = new ConsolidatedServiceNowService(
  ...
  it("should update ticket category", async () => {
    const request = {
      ...
      justification:
        "Root cause analysis identified network connectivity issue.",
    };
  ...
  it("should handle assignment validation error", async () => {
    ...
    expect(result.message).toContain(
      "Either assignedTo or assignmentGroup must be provided",
    );
  });
