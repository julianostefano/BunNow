...
describe('PerformanceMonitor', () => {
  ...
  describe('Reports and Analytics', () => {
    test('should generate performance report', () => {
      ...
      const now = Date.now();
      const metrics = [
        { name: 'response_time', value: 100, unit: 'ms', timestamp: now - 1000 },
        { name: 'response_time', value: 150, unit: 'ms', timestamp: now - 500 },
        { name: 'response_time', value: 200, unit: 'ms', timestamp: now },
        { name: 'error_rate', value: 2, unit: 'percentage', timestamp: now - 800 },
        { name: 'error_rate', value: 3, unit: 'percentage', timestamp: now - 200 }
      ];
      
      metrics.forEach(metric => monitor.recordMetric(metric as PerformanceMetric));
