 ...
 */
export const DEFAULT_CLIENT_CONFIG: Required<Omit<ClientConfig, "auth">> & {
...
export const API_ENDPOINTS = {
  ...
  SCHEDULED_TASK_TRIGGER: (id: string) =>
    `/api/v1/tasks/scheduled/${id}/trigger`,
...
export const REGEX_PATTERNS = {
  TASK_ID: /^[a-zA-Z0-9_-]+$/,
  CRON_EXPRESSION:
    /^(\*|(?:[0-5]?\d(?:(?:-[0-5]?\d)|(?:,[0-5]?\d)*)?)) (\*|(?:(?:[01]?\d)|(?:2[0-3])(?:(?:-(?:(?:[01]?\d)|(?:2[0-3])))|(?:,(?:(?:[01]?\d)|(?:2[0-3])))*)?)) (\*|(?:(?:0?[1-9])|(?:[12]\d)|(?:3[01])(?:(?:-(?:(?:0?[1-9])|(?:[12]\d)|(?:3[01])))|(?:,(?:(?:0?[1-9])|(?:[12]\d)|(?:3[01])))*)?)) (\*|(?:(?:0?[1-9])|(?:1[012])(?:(?:-(?:(?:0?[1-9])|(?:1[012])))|(?:,(?:(?:0?[1-9])|(?:1[012])))*)?)) (\*|(?:[0-6](?:(?:-[0-6])|(?:,[0-6])*)?))$/,
