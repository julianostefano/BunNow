...
export const createGlideElement = (name: string, value?: any, displayValue?: any) => 
  new GlideElement(name, value, displayValue);

export const createGlideRecord = (client: any, table: string, batchSize?: number, rewindable?: boolean) => 
